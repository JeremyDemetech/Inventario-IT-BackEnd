...
import { SqlDepartmentRepository } from '../../infrastructure/repositories/SqlDepartmentRepository';

export class DepartmentController {
  private repo = new SqlDepartmentRepository();

  /**
   * @swagger
   * /departments:
   *   get:
   *     summary: Obtener todos los Departments
   *     tags:
   *       - Departments
   *     responses:
   *       200:
   ...
   * /departments/{id}:
   *   get:
   *     summary: Obtener un Department por id
   *     tags:
   *       - Departments
   *     parameters:
   *       - in: path
   ...
   *   patch:
   *     summary: Activar/desactivar un Department
   *     tags:
   *       - Departments
   *     parameters:
   *       - in: path
